...
PUBLIC = [
    ...
    dict(name="stats_history", path=["stats_history.json"], kind="derived", live=True,
         ...
         row_schema="ts, recon, invoke, equip, growth, moca, creators, rate, balance, mente_balance, runway7, runway_adj (runway7/runway_adj = facts.float.days_7d_pace, total-outflow basis, since 2026-09-15)",
